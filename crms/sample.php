<?php
  ...
  if(isset($_POST['Name'])){
      ...
      $sql = "INSERT INTO criminal_info (`Criminal_ID`, `Name`, `Age`,
      `Date_of_Birth`, `Phone`, `Address`, `Height`, `Blood_Group`,
       `Crime_Committed`, `FIR_Number`, `Jail_Number`) VALUES ('$criminal_id','$name','$age',
       '$dob' ,'$phone','$address','$height','$blood_group','$crime_committed','$fir_no','$jail_no');";
     ...
     <body>
       <div class="testbox">
         <form action="sample.php" method="post">
           ...
           <div class="item">
             <label for="id">Criminal ID<span>*</span></label>
             <input id="id" type="text" name="Criminal_ID" required/>
           </div>
           <div class="item">
           ...
           <div class="item">
             ...
             <input id="bdate" type="date" name="Date of Birth" required/>
           ...
           <div class="question1">
             ...
             <div class="question1-answer">
               <div>
                 <input type="radio" value="none" id="radio_3" name="Prior_Arrest"/>
                 <label for="radio_3" class="radio"><span>Yes</span></label>
               </div>
               <div>
                 <input  type="radio" value="none" id="radio_4" name="Prior_Arrest"/>
