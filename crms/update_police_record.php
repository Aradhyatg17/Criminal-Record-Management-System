...
// $ph=$_POST['Phone'];
// // // $ad=$_POST['Address'];
// $jn=$_POST['Jail_Number'];
// $query = "DELETE FROM criminal_info WHERE Criminal_ID='$cid'";

// $data=mysqli_query($con,$query);
//
// if($data)
// {
//      echo "<font color='green'>Record Updated from Database";
// }
// else
// {
...
$query = "UPDATE police_info SET  Police_ID=$Police_ID ,No_of_Arrest=$No_of_Arrest, Phone=$Phone, Police_Station=$Police_Station WHERE Police_ID=$Police_ID";
...
<html>
  ...
  <body>
    <div class="testbox">
      <form action="update_police_record.php" method="post">
        <div class="banner">
        ...
        <div class="item">
          <label for="Police_ID">Police_ID<span>*</span></label>
          <input id="Police_ID" type="text"  name="Police_ID" required/>
        </div>

        <div class="item">
          <label for="No_of_Arrest">No_of_Arrest<span>*</span></label>
          <input id="No_of_Arrest" type="text"  name="No_of_Arrest" required/>
        </div>
        ...
        <div class="item">
          <label for="Police_Station">Police_Station<span>*</span></label>
