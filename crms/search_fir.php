  ...
  <body>
    <div class="testbox">
      <form action="search_fir.php" method="post">
        ...
        <p><b>Search FIR</b></p>
        <div class="item">
          <label for="id">Enter FIR Number<span>*</span></label>
...
if (!$connection){
    ...
    $id = $_POST['id'];
    // echo"$id";
    $sql="SELECT * FROM fir where FIR_Number=$id";
...
<table border="1" cellspacing="3">
   <tr>
       ...
       <td><?php echo $row['Name_of_Accused']; ?></td>
       <td><?php echo $row['Incident_Desc']; ?></td>
       <td><?php echo $row['Date_of_FIR_Filing']; ?></td>
