...
<html>
  ...
  <body>
    <div class="testbox">
      <form action="search_cr_record.php" method="post">
        <div class="banner">
          <h1 style="color:#3e2f5b;">Criminal Record Management System</h1>
        </div>
        <p><b>Search Criminal Record</b></p>
        <div class="item">
          <label for="cc">Enter Crime Commited<span>*</span></label>
          <input id="cc" type="text" name="cc" required/>
        </div>
...
if (!$connection){
    ...
    $id = $_POST['id'];
    // echo"$id";
    $sql="SELECT * FROM criminal_info where Crime_Committed=$cc";
