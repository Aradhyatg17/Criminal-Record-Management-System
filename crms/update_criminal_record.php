...
$query = "UPDATE criminal_info SET Criminal_ID=$Criminal_ID, Phone=$Phone, Jail_Number=$Jail_Number WHERE Criminal_ID=$Criminal_ID";
...
<html>
  ...
  <body>
    <div class="testbox">
      <form action="update_criminal_record.php" method="post">
        <div class="banner">
